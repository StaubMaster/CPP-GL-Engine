...
std::ostream & operator<<(std::ostream & o, const LineF2 & obj);
std::ostream & operator<<(std::ostream & o, const LineF3 & obj);

std::ostream & operator<<(std::ostream & o, const RayF2 & obj);
std::ostream & operator<<(std::ostream & o, const RayF3 & obj);
