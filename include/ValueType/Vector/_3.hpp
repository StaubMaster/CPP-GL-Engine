...
template<typename ValueType, typename VectorType>	VectorType		operator+(const Vector_3<ValueType, VectorType> & vec, ValueType val)	{ return VectorType(vec.X + val, vec.Y + val, vec.Z + val); }
template<typename ValueType, typename VectorType>	VectorType		operator-(const Vector_3<ValueType, VectorType> & vec, ValueType val)	{ return VectorType(vec.X - val, vec.Y - val, vec.Z - val); }
template<typename ValueType, typename VectorType>	VectorType		operator*(const Vector_3<ValueType, VectorType> & vec, ValueType val)	{ return VectorType(vec.X * val, vec.Y * val, vec.Z * val); }
template<typename ValueType, typename VectorType>	VectorType		operator/(const Vector_3<ValueType, VectorType> & vec, ValueType val)	{ return VectorType(vec.X / val, vec.Y / val, vec.Z / val); }

template<typename ValueType, typename VectorType>	VectorType		operator+(ValueType val, const Vector_3<ValueType, VectorType> & vec)	{ return VectorType(val + vec.X, val + vec.Y, val + vec.Z); }
template<typename ValueType, typename VectorType>	VectorType		operator-(ValueType val, const Vector_3<ValueType, VectorType> & vec)	{ return VectorType(val - vec.X, val - vec.Y, val - vec.Z); }
template<typename ValueType, typename VectorType>	VectorType		operator*(ValueType val, const Vector_3<ValueType, VectorType> & vec)	{ return VectorType(val * vec.X, val * vec.Y, val * vec.Z); }
template<typename ValueType, typename VectorType>	VectorType		operator/(ValueType val, const Vector_3<ValueType, VectorType> & vec)	{ return VectorType(val / vec.X, val / vec.Y, val / vec.Z); }
