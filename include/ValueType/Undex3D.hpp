...
struct Undex3D
{
	...
	public:
	Undex3D();
	Undex3D(unsigned int x, unsigned int y, unsigned int z);
	~Undex3D();

	Undex3D(const Undex3D & other);
	Undex3D & operator=(const Undex3D & other);



	Undex3D operator+(const Undex3D & other) const;
	Undex3D operator-(const Undex3D & other) const;
	Undex3D operator*(unsigned int shift) const;
	Undex3D operator/(unsigned int shift) const;
	...
	Bool3D operator==(const Undex3D & other) const;
	Bool3D operator<=(const Undex3D & other) const;
	Bool3D operator>=(const Undex3D & other) const;
	Bool3D operator!=(const Undex3D & other) const;
	Bool3D operator<(const Undex3D & other) const;
