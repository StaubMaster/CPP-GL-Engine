...
UserParameter::KeyBoard::Key::Data	& UserParameter::KeyBoard::KeyRange1::operator [](unsigned short token)
{
	return Keys[token - TokenMin];
}
const UserParameter::KeyBoard::Key::Data & UserParameter::KeyBoard::KeyRange1::operator [](unsigned short token) const
{
	return Keys[token - TokenMin];
}
