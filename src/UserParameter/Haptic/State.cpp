...
bool	UserParameter::Haptic::State::IsDown() const
{ return (Flags & HAPTIC_STATE_UD_BIT) == HAPTIC_STATE_D_BIT; }
bool	UserParameter::Haptic::State::IsUp() const
{ return (Flags & HAPTIC_STATE_UD_BIT) == HAPTIC_STATE_U_BIT; }
bool	UserParameter::Haptic::State::IsPress() const
{ return (Flags & HAPTIC_STATE_PR_BIT) == HAPTIC_STATE_P_BIT; }
bool	UserParameter::Haptic::State::IsRelease() const
{ return (Flags & HAPTIC_STATE_PR_BIT) == HAPTIC_STATE_R_BIT; }
