...
//std::ostream & operator<<(std::ostream & o, const LineF2 & obj) { return o; }
//std::ostream & operator<<(std::ostream & o, const LineF3 & obj) { return o; }

//std::ostream & operator<<(std::ostream & o, const RayF2 & obj) { return o; }
//std::ostream & operator<<(std::ostream & o, const RayF3 & obj) { return o; }
